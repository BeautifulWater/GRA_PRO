  ...
  api.registerGenerator({
    ...
    fn: async () => {
      ...
      if (import_utils.semver.neq(reactVersion, reactDomVersion)) {
        import_utils.logger.warn(`The react version ${reactVersion} is not equal to the react-dom version ${reactDomVersion}, please check.`);
      }
      ...
      (0, import_fs.writeFileSync)((0, import_path.join)(api.cwd, "tsconfig.json"), `
{
...
`.trimStart());
      ...
      (0, import_fs.writeFileSync)((0, import_path.join)(api.cwd, "typings.d.ts"), `import '${importSource}/typings';`.trimStart());
