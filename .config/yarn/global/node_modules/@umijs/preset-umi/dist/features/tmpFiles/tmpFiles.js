  ...
  api.register({
    ...
    fn: async () => {
      ...
      for (const plugin of allPlugins) {
        const runtimeConfigFile = (0, import_utils.winPath)((0, import_path.join)(api.paths.absTmpPath, plugin, import_umi.RUNTIME_TYPE_FILE_NAME));
        if ((0, import_fs.existsSync)(runtimeConfigFile)) {
          const noSuffixRuntimeConfigFile = runtimeConfigFile.replace(/\.ts$/, "");
          beforeImport.push(`import type { IRuntimeConfig as Plugin${pluginIndex} } from '${noSuffixRuntimeConfigFile}'`);
